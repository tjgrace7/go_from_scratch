...
- [x] TCP server with a text protocol (SET, GET, DELETE)
- [x] TTL/expiry on keys
- [x] Append-only log for persistence across restarts
- [x] Benchmark: ops/sec with 10 concurrent clients
- [x] Multiple concurrent clients without data corruption
